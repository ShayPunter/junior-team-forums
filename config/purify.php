    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,strong,i,em,s,del,a[href|title],ul,ol,li,p[style|class],br,span[class|style],img[width|height|alt|src],blockquote,pre[class]',
