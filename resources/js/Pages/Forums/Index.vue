...
<template>
    <AdminLayout title="Forums">
        <template #pagehead>
            <PageHeader title="Forums" :button="true" :button_link="route('forums.create')" button_text="Add Forum"></PageHeader>
        </template>
                    ...
                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        <div class="relative overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                            <table class="min-w-full table-fixed divide-y divide-gray-300">
                                ...
                                <tr v-for="forum in $page.props.forums" :key="forum.position" class="bg-gray-50">
