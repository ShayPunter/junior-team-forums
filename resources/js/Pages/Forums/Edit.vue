                        ...
                        <div class="space-y-6 sm:space-y-5">
                            <div class="space-y-6 sm:space-y-5">
                                ...
                                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                                    ...
                                    <div class="mt-1 sm:col-span-2 sm:mt-0">
                                        <select v-for="category in $page.props.categories" v-model="form.category" id="category" name="category" autocomplete="category" class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs sm:text-sm">
